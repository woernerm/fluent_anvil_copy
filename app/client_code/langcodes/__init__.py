...
class Language:
    ...
    @staticmethod
    def get(tag: str, normalize=True):
        """
        ...
        """
        from .data_dicts import LANGUAGE_REPLACEMENTS
        ...
        from .tag_parser import normalize_characters, parse_tag
        ...
        for typ, value in components:
            if typ == 'extlang' and normalize and 'language' in data:
                ...
                if normalize:
                    from .data_dicts import TERRITORY_REPLACEMENTS
    ...
    def simplify_script(self):
        ...
        if self.language and self.script:
            from .data_dicts import DEFAULT_SCRIPTS
    ...
    def prefer_macrolanguage(self):
        ...
        """
        from .data_dicts import NORMALIZED_MACROLANGUAGES
    ...
    def to_alpha3(self, variant: str = 'T') -> str:
        ...
        'und'
        """
        from .data_dicts import LANGUAGE_ALPHA3, LANGUAGE_ALPHA3_BIBLIOGRAPHIC
    ...
    def maximize(self):
        ...
        for tag in self.broader_tags():
            from .data_dicts import LIKELY_SUBTAGS
    ...
    def distance(self, supported) -> int:
        """
        ...
        from .language_distance import tuple_distance_cached
    ...
    def is_valid(self) -> bool:
        ...
        for subtag in subtags:
            if subtag is not None:
                ...
                from .data_dicts import VALIDITY
                if not subtag.startswith('x-') and not VALIDITY.match(subtag):
                    from .data_dicts import ALL_SCRIPTS
    ...
    def _get_name(
        self, attribute: str, language: str, max_distance: int
    ) -> str:
        try:
    ...
    def _best_name(
        self, names: str, language, max_distance: int
    ):
    ...
    @staticmethod
    def find_name(
        tagtype: str, name: str, language = None
    ):
        """
    ...
    def update_dict(self, newdata: dict):
        """
    ...
    @staticmethod
    def _filter_keys(d: dict, keys: str) -> dict:
        """
        Select a subset of keys from a dictionary.
        """
        return {key: d[key] for key in keys if key in d}

    def _filter_attributes(self, keyset: str):
        """
...
def tag_is_valid(tag: str) -> bool:
    ...
    False
    """
    from .tag_parser import LanguageTagError
...
def tag_distance(desired: str, supported: str) -> int:
    """
